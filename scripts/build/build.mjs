...
const sourceMapFooter = s => watch ? "" : `//# sourceMappingURL=flocord://${s}.js.map`;
...
const buildConfigs = ([
    ...
    {
        ...commonOpts,
        entryPoints: [join(dirname(fileURLToPath(import.meta.url)), "../../src/Flocord.ts")],
        outfile: "dist/desktop/renderer.js",
        format: "iife",
        target: ["esnext"],
        footer: { js: "//# sourceURL=file:///FlocordRenderer\n" + sourceMapFooter("renderer") },
        globalName: "Flocord",
        sourcemap,
        plugins: [
    ...
    },
    {
        ...
        footer: { js: "//# sourceURL=file:///FlocordPreload\n" + sourceMapFooter("preload") },
        sourcemap,
        define: {
            ...defines,
            IS_DISCORD_DESKTOP: "true",
    ...
    // Flocord Desktop main & renderer & preload
    {
        ...nodeCommonOpts,
        entryPoints: [join(dirname(fileURLToPath(import.meta.url)), "../../src/main/index.ts")],
        outfile: "dist/equibop/main.js",
        banner: { js: "(function(){if(typeof global!==\"undefined\"&&global.__flocordMainLoaded)return;if(typeof global!==\"undefined\")global.__flocordMainLoaded=true;" },
        footer: { js: "})();\n//# sourceURL=file:///FlocordDesktopMain\n" + sourceMapFooter("main") },
        sourcemap,
        plugins: [
            ...nodeCommonOpts.plugins,
            globNativesPlugin
    ...
    },
    {
        ...
        format: "iife",
        target: ["esnext"],
        footer: { js: "//# sourceURL=file:///FlocordDesktopRenderer\n" + sourceMapFooter("renderer") },
        globalName: "Flocord",
        sourcemap,
        plugins: [
            globPlugins("equibop"),
