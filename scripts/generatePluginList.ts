...
import { getEntryPoint, isPluginFile, parseDevs, parseFlocordDevs, parseFile, PluginData } from "./utils";
...
(async () => {
    ...
    const flocordFlag = args.includes("--flocord");
            ...
            readdirSync(dir, { withFileTypes: true })
                ...
                .map(async dirent => {
                    try {
                        ...
                        if (dir.includes("flocordplugins")) return;
                        throw e;
                    }
                })
        )
