...
function EquibopSection() {
    ...
    return (
        <Flex className={Margins.bottom20} flexDirection="column" gap="1em">
            <Card variant="brand">
                <HeadingSecondary>Equibop & Flocord</HeadingSecondary>
                <Paragraph>Equibop and Flocord are two separate things. This updater is for Flocord.</Paragraph>
    ...
    return (
        <SettingsTab>
            ...
            <Paragraph className={Margins.bottom20}>
                Control how Flocord keeps itself up to date. You can choose to update automatically in the background or be notified when new updates are available.
            </Paragraph>

            <FormSwitch
                title="Automatically update"
                description="When enabled, Flocord will automatically download and install updates in the background without asking for confirmation. You'll need to restart Discord to apply the changes."
            ...
            <FormSwitch
                ...
                description="Receive a notification when Flocord finishes downloading an update in the background, so you know when to restart Discord."
            ...
            <Paragraph className={Margins.bottom8}>
                This is the GitHub repository where Flocord fetches updates from.
            </Paragraph>
