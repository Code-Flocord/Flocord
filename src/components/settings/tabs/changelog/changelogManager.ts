...
const CHANGELOG_HISTORY_KEY = "FlocordChangelog_History";
const LAST_SEEN_HASH_KEY = "FlocordChangelog_LastSeenHash";
const KNOWN_PLUGINS_KEY = "FlocordChangelog_KnownPlugins";
const KNOWN_SETTINGS_KEY = "FlocordChangelog_KnownSettings";
const LAST_REPO_CHECK_KEY = "FlocordChangelog_LastRepoCheck";
