    ...
    return (
        <section className={Margins.top16}>
            ...
            <Paragraph className={Margins.bottom8}>
                Settings for Notifications sent by Flocord.
    ...
    return (
        <>
            ...
            <Paragraph className={Margins.bottom8}>
                ...
                <ul>
                    <li><strong>Flocord Notifications</strong>: These are in-app notifications</li>
            ...
            <Select
                ...
                options={[
                    ...
                    { label: "Always use Flocord notifications", value: "never" },
