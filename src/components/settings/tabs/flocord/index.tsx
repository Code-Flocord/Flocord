...
const cl = classNameFactory("vc-flocord-tab-");
        ...
        <SettingsTab>
            {isAnyPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to Flocord you now have a cool new badge!"
            ...
            <Paragraph className={Margins.bottom16}>
                Configure how Flocord behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.
            </Paragraph>
...
export default wrapTab(FlocordSettings, "Flocord Settings");
