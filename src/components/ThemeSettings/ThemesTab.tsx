...
function ThemesTab() {
    ...
    const [themeDir] = useAwaiter(FlocordNative.themes.getThemesDir);
    ...
    async function refreshLocalThemes() {
        const themes = await FlocordNative.themes.getThemesList();
    ...
    async function onFileUpload(e: SyntheticEvent<HTMLInputElement>) {
        ...
        const uploads = Array.from(files, file => {
            ...
            return new Promise<void>((resolve, reject) => {
                ...
                reader.onload = () => {
                    FlocordNative.themes.uploadTheme(name, reader.result as string)
                        .then(resolve)
                        .catch(reject);
                };
            ...
            <QuickActionCard>
                {IS_WEB ? (
                    ...
                    <QuickAction
                        ...
                        action={() => FlocordNative.themes.openFolder()}
                        Icon={FolderIcon}
                    />
                )}
                <QuickAction
                            ...
                            return (
                                <UserCSSThemeCard
                                    ...
                                    onDelete={async () => {
                                        ...
                                        await FlocordNative.themes.deleteTheme(usercssTheme.fileName);
                                        refreshLocalThemes();
                                    }}
                        ...
                        return (
                            <OtherThemeCard
                                ...
                                onDelete={async () => {
                                    ...
                                    await FlocordNative.themes.deleteTheme(localTheme.fileName);
                                    refreshLocalThemes();
                                }}
                                showDeleteButton
...
export function CspErrorCard() {
    ...
    const allowUrl = async (url: string) => {
        ...
        const result = await FlocordNative.csp.requestAddOverride(baseUrl, ["connect-src", "img-src", "style-src", "font-src"], "Flocord Themes");
        if (result !== "ok") return;
