...
export interface PluginDef {
    ...
    /**
     * Allows you to add custom actions to the Flocord Toolbox.
     *
    ...
    /*
    * Custom apis added by Flocord and were placed here for quicker identification rather then mixing them in
    */
    ...
    /**
     * A Vencord plugin that is modified for extra features in Flocord
     */
    isModified?: boolean;
}

export const enum StartAt {
    /** Right away, as soon as Flocord initialised */
    Init = "Init",
