...
declare module "usercss-meta" {
    ...
    export interface UserstyleHeader {
         ...
         *
         * @flocord Specific to Flocord (inherited from Vencord), not part of the original module.
         */
        id: string;
         ...
         *
         * @flocord This is a Flocord/Vencord-specific extension, however we wish for this to become a standard for client mods
