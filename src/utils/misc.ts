...
import { FlocordDevsById, VencordDevsById } from "./constants";
...
export const isFlocordPluginDev = (id: string) => Object.hasOwn(FlocordDevsById, id);
export const shouldShowFlocordContributorBadge = (id: string) => isFlocordPluginDev(id) && FlocordDevsById[id].badge !== false;

export const isAnyPluginDev = (id: string) => Object.hasOwn(VencordDevsById, id) || Object.hasOwn(FlocordDevsById, id);
