...
function FlocordPopoverButtons(props: { Component: React.ComponentType<MessagePopoverButtonItem>, message: Message; }) {
...
export function _buildPopoverElements(
    ...
    return <FlocordPopoverButtons Component={Component} message={message} />;
}
