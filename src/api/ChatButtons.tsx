...
function FlocordChatBarButtons(props: ChatBarProps) {
...
export function _injectButtons(buttons: ReactNode[], props: ChatBarProps) {
    ...
    buttons.unshift(<FlocordChatBarButtons key="flocord-chat-buttons" {...props} />);
}
...
addContextMenuPatch("textarea-context", (children, args) => {
    ...
    group.splice(idx, 0,
        <Menu.MenuItem id="vc-chat-buttons" key="flocord-chat-buttons" label="Flocord Buttons">
            {buttons.map(([id]) => (
