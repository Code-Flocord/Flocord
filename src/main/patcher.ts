...
console.log("[Flocord] Starting up...");
...
if (!IS_VANILLA) {
    ...
    if (!IS_VESKTOP && !IS_EQUIBOP) {
        try {
            ...
            console.error("[Flocord] Failed to install host update hook", err);
        }
    }
    ...
    process.env.DATA_DIR = join(app.getPath("userData"), "..", "Flocord");
    ...
    console.log("[Flocord] Running in vanilla mode. Not loading Flocord");
}
...
console.log("[Flocord] Loading original Discord app.asar");
