...
export const Forms = {
    ...
    /** @deprecated use Heading from @components */
    FormTitle: Heading,
    /** @deprecated use Paragraph from @components */
    FormText: Paragraph,
...
/** @deprecated use Paragraph, Span, or BaseText from @components */
export const Text = TextCompat;
/** @deprecated use Button from @components */
export const Button = ButtonCompat;
/** @deprecated Use FormSwitch from @components */
...
/** @deprecated import from @components/TooltipContainer */
