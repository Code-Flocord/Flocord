            ...
            replacement: [
                {
                    ...
                    replace: "children:[Flocord.Api.MemberListDecorators.__getDecorators(arguments[0],'guild'),"
                }
            ]
        },
        {
            ...
            replacement: {
                ...
                replace: "decorators:[Flocord.Api.MemberListDecorators.__getDecorators(arguments[0],'dm'),$1]"
            }
        },
