    ...
    patches: [
        {
            ...
            replacement: {
                ...
                replace: (match, args) => "" +
                    `async ${match}` +
                    `if(await Flocord.Api.MessageEvents._handlePreEdit(${args}))` +
        ...
        },
        {
            ...
            replacement: {
                ...
                replace: (m, restCode, parsedMessage, channel, contentOptions, options, props) => "async " + restCode +
                    `if(await Flocord.Api.MessageEvents._handlePreSend(${channel}.id,${parsedMessage},${options},${props},${contentOptions}))` +
        ...
        },
        {
            ...
            replacement: {
                ...
                replace: (m, message, channel, event) =>
                    `const vcMsg=${message},vcChan=${channel};${m}Flocord.Api.MessageEvents._handleClick(vcMsg,vcChan,${event});`
            }
        }
    ]
});
