...
import { AchievementsIcon, AppsIcon, CreditCardIcon, FlocordIcon, GameControllerIcon, HammerAndChiselIcon, MainSettingsIcon, PencilSparkleIcon, UserIcon } from "@components/Icons";
import { buildPluginMenuEntries, buildThemeMenuEntries } from "@flocordplugins/flocordToolbox/menu";
...
export default definePlugin({
    ...
    patches: [
            ...
            replacement: [
                {
                    ...
                    replace: "var $1=$self.Layer;class FlocordPatchedOldFadeLayer",
        ...
        { // Load menu TOC eagerly
            ...
            replacement: {
                ...
                replace: "_flocordBetterSettingsEagerLoad=(async ()=>$1)();"
            },
            predicate: () => settings.store.eagerLoad
        },
    ...
    Layer(props: LayerProps) {
        try {
            [FocusLock.$$flocordGetWrappedComponent(), ComponentDispatch, Classes.layer].forEach(e => e.test);
        } catch {
    ...
    transformSettingsEntries(list) {
        ...
        for (const item of flat) {
            ...
            if (key === "flocord_plugins" || key === "flocord_themes") {
                const children = key === "flocord_plugins"
