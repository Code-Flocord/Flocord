...
import { ScreenshareProfile, ScreenshareStore } from "@flocordplugins/betterScreenshare.desktop/stores";
import { ProfilableStore, replaceObjectValuesIfExist, types, utils } from "@flocordplugins/philsPluginLibrary";
