...
import { Alerts, Button, Menu, Modal, React, showToast, Text, Toasts, useEffect, useRef, UserStore, useState } from "@webpack/common";
...
function StreamPreviewPanelButton({ iconForeground, hideTooltips, nameplate }: UserAreaRenderProps) {
    ...
    return (
        <UserAreaButton
            tooltipText={hideTooltips ? void 0 : renderTooltip()}
            icon={
                <span className={iconForeground}>
                    <StreamPreviewIcon
...
export default definePlugin({
    ...
    userAreaButton: {
        icon: ImageIcon,
        render: StreamPreviewPanelButton
    },
