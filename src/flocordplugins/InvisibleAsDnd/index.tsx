...
export default definePlugin({
    name: "InvisibleAsDnd",
    description: "Applies Do Not Disturb behaviour to notifications while your status is invisible.",
    ...
    patches: [
        {
            ...
            replacement: [
                ...
                {
                    // Tolerates OnePingPerDM having rewritten the sound expression first
                    match: /sound:(.{0,150}?,volume:\i,onClick)/,
