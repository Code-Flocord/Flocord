...
import { FluxDispatcher, Menu, React, Toasts, MessageStore, openModal, SelectedChannelStore, Button, TextInput, Modal, showToast, Switch } from "@webpack/common";
import { ModalContent, ModalHeader, ModalFooter, ModalCloseButton } from "@utils/modal";
...
export default definePlugin({
    ...
    start() {
        ...
        FluxDispatcher.dispatch = function (event: any) {
            // Only scan events that can contain chat messages
