...
async function getAllThemes(): Promise<ThemeItem[]> {
    ...
    if (settings.store.includeLocal) {
        const localThemes: ThemeFile[] = await FlocordNative.themes.getThemesList();
...
async function watchForLocalThemeChanges() {
    ...
    const currentThemes = await FlocordNative.themes.getThemesList();
