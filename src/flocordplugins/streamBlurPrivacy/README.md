...
1. Placez ce dossier dans votre répertoire de plugins Flocord : `src/userplugins/streamBlurPrivacy/`
2. Rechargez Discord ou lancez l'injecteur de plugins
3. Activez le plugin dans les paramètres de Flocord
...
3. **Gestion de l'état** :
   - Stocke les IDs des canaux floutés dans le DataStore de Flocord
...
1. Vérifiez que "Stream Blur Privacy" est activé dans les plugins Flocord
...
Yes, the list of blurred conversations is saved to Flocord's DataStore and automatically loaded when Discord starts.
