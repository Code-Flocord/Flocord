...
const Native = FlocordNative.pluginHelpers.FavouriteAnything as PluginNative<typeof import("./native")>;
...
const fallbackThumbnail = new URL("https://placehold.jp/42/444/fff/128x128.png?text=invalid");
